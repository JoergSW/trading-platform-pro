...
- no market-data request, broker connection, order action or trading action

Price history, indicators, strategy analysis and provider-backed instrument details remain
future product slices. Missing analysis data is not estimated or generated by the UI.
