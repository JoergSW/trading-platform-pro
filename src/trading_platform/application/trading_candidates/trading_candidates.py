...
class TradingCandidateService:
    """Coordinate persistent Trading Candidate intake and collection reads."""
    ...
    def add_candidate(
        ...
        refresh_error = self._refresh_after_intake()
    ...
    def _error_outcome(self, error: Exception) -> TradingCandidateAddOutcome:
    ...
    def _refresh_after_intake(self) -> str | None:
        try:
            candidates = self._repository.list_candidates()
        except Exception as exc:
