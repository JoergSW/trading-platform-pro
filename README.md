...
* read-only Scanner workspace backed by validated Application-owned results
...
time. Missing, malformed or invalid files remain explicit `UNAVAILABLE` outcomes; no
scanner candidates are inferred, reused or generated by the UI.
